...
function S_getMarkersCoord(rpta)
{
  ...
  for (especie in especies) {
    GoogleMap.addMarker({ 
      ...
      infoWindow: {
        content: '<a href="index.php?c=Index&a=mostrar_imagen&ID='+especies[especie]['ID']+'&especie='+especies[especie]['ID_taxonomia']+'&Taxonomia='+especies[especie]['ID_taxonomia']+'"> Especie: '+especies[especie]['NOMBRE_COMUN']+' <br> Calle: '+especies[especie]['CALLE']+' <br> Código: '+especies[especie]['ID']+'</a>'
