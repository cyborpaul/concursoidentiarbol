...
$query = mysqli_query($mysqli,"SELECT * FROM lista where Autor=$id and habilitado=1 order by hora desc");
...
?>
                    ...
                    <tr>
                      ...
                      <td>
                        <a class="link_edit" href="edit.php?codarbol=<?php echo $data["ID"]; ?>"><i class="fa fa-edit" style="color:#4B9D44;"></i></a>
